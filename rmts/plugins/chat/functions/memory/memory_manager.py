...
class MemoryManager:
    ...
    def add_memories(self, group_id: str, doctor_id: str, memories: List[Memory]) -> None:
        """
        添加记忆：
        参数：
            group_id: 群号
    ...
    def get_user_all_memories(self, group_id: str, doctor_id: str) -> Optional[MemoryUnit]:
        """
        获取用户所有记忆：
        参数：
            group_id: 群号
